...
// Define the types if not already defined in your data
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <h1 className="text-3xl font-semibold text-gray-800 mb-4">Plan Details</h1>
      {params?.plancase ? (
        <p className="text-xl text-gray-600 mb-6">Plan Case: {params.plancase}</p>
      ) : (
            ...
            <div className=" pl-5 text-gray-600">
              {planObject.inputs.map((input, index) => (
                <div key={input.field} className="mb-4">
                  <label htmlFor={input.field} className="block text-md text-gray-700 font-semibold mb-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setInputs((prev: any) => ({ ...prev, [input.field]: e.target.value }))}
                  />
                </div>
              ))}
            </div>
